...
public:
    ...
    void render(int x, int y)
    {
        ...
        SDL_RenderCopy(g_renderer, m_texture, NULL, &renderQuad);
    }
...
bool loadMedia()
{
    ...
    if (g_fooTexture.loadFromFile("resources/foo.png") == false)
    {
        SPDLOG_ERROR("Failed to load image!");
        success = false;
    }
    if (g_backgroundTexture.loadFromFile("resources/background.png") == false)
    {
        SPDLOG_ERROR("Failed to load image!");
        success = false;
    }
